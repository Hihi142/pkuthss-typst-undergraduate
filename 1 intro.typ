...
为此，人们尝试了多种手段来加强软件安全性。其中，形式化验证（formal verification）利用数学和逻辑的方法，证明程序严格符合预期规范，从而保障其安全性。20世纪60年代，Floyd、 Hoare就提出了霍尔逻辑（Hoare Logic） @HoareLogic，奠定了形式化验证程序正确性的理论基础；但由于相关基础设施建设极其困难，直到近二十年内形式化验证才逐步投入实际应用。目前，形式化验证已经在操作系统 @chajed2022daisynfs, @SEL4、编译器 @leroy2016compcert、密码学协议 @woos2016raft 等高安全需求领域得到应用。
